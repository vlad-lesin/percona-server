...
/**
  ...
  @details
  This function creates a new native_part::Partition_base handler as a clone/copy. The
  ...
  In native_part::Partition_base::open() it will clone its original handlers partitions
...
handler *ha_rockspart::clone(const char *name, MEM_ROOT *mem_root)
{
  ...
  /*
    ...
    native_part::Partition_base::open() for clones. Also set_ha_share_ref is not needed
